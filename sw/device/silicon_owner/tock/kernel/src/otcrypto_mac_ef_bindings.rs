...
trait LibOTCryptoMACRv32iCRt:
    ...
    + ::encapfn::rt::rv32i_c::Rv32iCRt<
        0usize,
        ::encapfn::abi::calling_convention::AREG0<::encapfn::abi::rv32i_c::Rv32iCABI>,
    > + ::encapfn::rt::rv32i_c::Rv32iCRt<
        8usize,
    ...
    for LibOTCryptoMACRt<'_, ID, RT>
{
    ...
    fn demo_nop(
        ...
        #[naked]
        unsafe extern "C" fn demo_nop_int<
            RT: ::encapfn::rt::rv32i_c::Rv32iCRt<
                0usize,
                ::encapfn::abi::calling_convention::AREG0<::encapfn::abi::rv32i_c::Rv32iCABI>,
            >,
        ...
        let ef_sym = self.rt().lookup_symbol(6usize, &self.symbols).unwrap();
        ...
        self.rt().execute(move || unsafe {
            demo_nop_int::<RT>(self.rt(), ef_sym, ef_res_borrowed);
        });
