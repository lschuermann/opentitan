...
_NORMAL_DEPENDENCIES = {
    "third_party/rust": {
        _COMMON_CONDITION: {
            ...
            "tar": "@crate_index__tar-0.4.39//:tar",
...
def crate_repositories():
    ...
    maybe(
        http_archive,
        name = "crate_index__tar-0.4.39",
        sha256 = "ec96d2ffad078296368d46ff1cb309be1c23c513b4ab0e22a45de0185275ac96",
        type = "tar.gz",
        urls = ["https://crates.io/api/v1/crates/tar/0.4.39/download"],
        strip_prefix = "tar-0.4.39",
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.tar-0.4.39.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "crate_index__web-sys-0.3.61",
        ...
        build_file = Label("@lowrisc_opentitan//third_party/rust/crates:BUILD.web-sys-0.3.61.bazel"),
    )
