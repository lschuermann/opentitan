...
impl<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>> digest::HmacSha256 for OTCryptoLibHMAC<'l, ID, RT, L> {
...
impl<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>> digest::HmacSha384 for OTCryptoLibHMAC<'l, ID, RT, L> {
    fn set_mode_hmacsha384(&self, key: &[u8]) -> Result<(), ErrorCode> {
        unimplemented!()
    }
}

impl<'l, ID: EFID, RT: EncapfnRt<ID = ID>, L: LibOTCryptoMAC<ID, RT, RT = RT>> digest::HmacSha512 for OTCryptoLibHMAC<'l, ID, RT, L> {
